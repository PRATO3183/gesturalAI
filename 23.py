    ...
    while cap.isOpened():
        ...
        if result.pose_landmarks:
            mp_drawing.draw_landmarks(
                frame_bgr, result.pose_landmarks, mp_holistic.POSE_CONNECTIONS
            )
        ...
        draw_text_with_background(
            frame_bgr, f"Score: {score}", (50, 100), background_color=(0, 0, 255)
        )
        draw_text_with_background(
            frame_bgr,
        ...
        cv2.setWindowProperty(
            "PhysioPlay Game", cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN
        )
